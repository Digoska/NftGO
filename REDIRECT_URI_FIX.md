...
❌ **Wrong**: `https://wkpgupdorbgcthmjoybe.supabase.co/auth/v1/callback/` (trailing slash)
✅ **Correct**: `https://wkpgupdorbgcthmjoybe.supabase.co/auth/v1/callback`

❌ **Wrong**: `http://wkpgupdorbgcthmjoybe.supabase.co/auth/v1/callback` (http instead of https)
✅ **Correct**: `https://wkpgupdorbgcthmjoybe.supabase.co/auth/v1/callback`
