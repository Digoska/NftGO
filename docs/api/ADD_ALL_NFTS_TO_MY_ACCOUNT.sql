...
-- ============================================
-- Your User ID: 908149f0-85fe-4351-893f-464e3dc5d863
...
SELECT 
  '908149f0-85fe-4351-893f-464e3dc5d863'::UUID as your_user_id,
  (SELECT email FROM auth.users WHERE id = '908149f0-85fe-4351-893f-464e3dc5d863'::UUID) as your_email,
  (SELECT username FROM users WHERE id = '908149f0-85fe-4351-893f-464e3dc5d863'::UUID) as your_username,
...
FROM user_nfts
WHERE user_id = '908149f0-85fe-4351-893f-464e3dc5d863'::UUID;
...
SELECT 
  '908149f0-85fe-4351-893f-464e3dc5d863'::UUID as user_id,
  n.id as nft_id,
  NULL as spawn_id,
  NOW() as collected_at
FROM nfts n
WHERE NOT EXISTS (
  ...
  SELECT 1 
  FROM user_nfts un 
  WHERE un.user_id = '908149f0-85fe-4351-893f-464e3dc5d863'::UUID
    AND un.nft_id = n.id
)
