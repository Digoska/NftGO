...
## Problem
When signing in with Google, the dialog shows "Sign in to continue to REDACTED_SUPABASE_URL" instead of your app name.
...
**Before:**
- Dialog shows: "Sign in to continue to REDACTED_SUPABASE_URL"
...
- The Supabase URL (`REDACTED_SUPABASE_URL`) will still be in the OAuth callback flow, but the **user-facing dialog** will show your app name
